...
declare module 'acorn-jsx' {
	...
	export interface JSXEmptyExpression extends BaseExpression {
	...
	export interface MemberExpression extends BaseExpression {
		...
		computed: boolean;
		name?: string;
		object: Literal | MemberExpression | Identifier;
	...
	export type Expression =
		...
		JSXSpreadAttribute | JSXFragment | JSXText | JSXEmptyExpression |
